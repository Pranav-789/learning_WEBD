...
//   }
  ...
  try {
    ...
    throw new ApiError(500, "Something went wrong, deleted images")
  }
});  
...
const generateAccessandRefreshToken = async(userId)=>{
  try {
    ...
    throw new ApiError(500, "Something wrong happpened in login")
  }
}
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  res.status(200).json(new ApiError(200, user, "Cover Image updated successfully"));
});
